...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    ...
    setPassword(pass);
  },[length, numberAllowed, charAllowed, setPassword]) /*Normally this function can not be called you need useEffect Hook to call it. */
  ...
  return (
    <>
     <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-600 bg-gray-700'>
      <h1 className='text-white my-auto py-3'>Password Generator</h1>
